    ...
    <div className="space-y-6">
          ...
          <CardContent className="p-0">
             <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <p className="text-[10px] font-bold text-slate-400 tracking-widest uppercase">Mean Aggregate</p>
                  <TrendingUp size={16} className="text-emerald-500" />
                </div>
                <div className="flex items-baseline gap-3 mb-6">
                   <h3 className="text-4xl font-black text-slate-900 tracking-tight">{avg}%</h3>
                   <span className="text-[10px] font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-full border border-emerald-100">+2.4% vs Term 1</span>
                </div>
        ...
        <Card className="shadow-sm border-slate-200 bg-white lg:col-span-2">
          <CardHeader className="p-6 pb-0">
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm font-bold text-slate-900">High School Portfolio</CardTitle>
              <p className="text-[10px] font-bold text-indigo-600 uppercase tracking-widest">{marks.length} Exam Units</p>
            </div>
          </CardHeader>
          <CardContent className="p-6">
            ...
            <div className="flex items-center justify-between">
               ...
               <p className="text-[10px] font-bold text-slate-400 italic">Advanced analytics available in Career Hub</p>
            </div>
          </CardContent>
        </Card>
      </div>
              ...
              <div className="flex gap-5">
                 ...
                 <div>
                    ...
                    <div className="flex items-center gap-2">
                       ...
                       <span className="text-[10px] font-black text-indigo-400 flex items-center gap-1"><Medal size={10} /> Distinction</span>
                    </div>
                 </div>
              </div>
           </CardContent>
      ...
      <Card className="shadow-sm border-slate-200 overflow-hidden">
        <CardHeader className="px-6 py-5 border-b border-slate-100 bg-slate-50/40">
           <div className="flex items-center justify-between">
              <div>
                 <CardTitle className="text-base font-bold text-slate-900 tracking-tight">Main Examination Body</CardTitle>
                 <CardDescription className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.1em] mt-0.5">Mock Terminal Assessments • May 2024</CardDescription>
              </div>
           ...
           <Table>
              <TableHeader>
                <TableRow className="hover:bg-transparent border-b border-slate-100 bg-slate-50/20">
                  ...
                  <TableHead className="py-4 text-[10px] font-bold uppercase tracking-wider text-slate-400 text-center">Class Median</TableHead>
